...
package
{
	...
	public class Assets
	{
		...
		[Embed(source="../assets/miniSpheres.png")]
		static private var etalon:Class;
		...
		static public var ETALON_ID:String = "ETALON_ID";
		...
		static public function init():void
		{
			...
			BBTexture.createFromAsset(etalon, ETALON_ID);
